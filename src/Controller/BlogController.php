...
/**
 * @file
 * Contains \Drupal\phok_blog\Controller\BlogController.
 */

namespace Drupal\phok_blog\Controller;

use Drupal\phok_blog\BlogListerInterface;
...
class BlogController implements ContainerInjectionInterface {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('phok_blog.lister')
    );
  }
